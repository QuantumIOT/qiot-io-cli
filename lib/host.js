...
Host.prototype.request = function(options,message){
  ...
  if (self.authenticate && self.config.settings.auth_token) defaultHeaders.Authorization = 'Bearer ' + self.config.settings.auth_token;
  ...
  return new Promise(function(resolve,reject){
    self.logger.debug(function() { return 'host ' + options.method + ' ' + options.path + ' : ' + messageJSON; });
